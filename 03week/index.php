...
$query = 'SELECT c.customerID, c.emailAddress, c.firstName, c.lastName, a.line1, a.city, a.state, a.zipCode, a.phone FROM customers c JOIN addresses a ON c.customerID = a.customerID GROUP BY a.line1 ORDER BY c.customerID';
